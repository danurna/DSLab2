 ...
 * <p/>
 * Internally, the lines convertFileToByteArray from the underlying {@link InputStream} are buffered and can be retrieved on demand for
 * verification purposes.
 */
public class TestInputStream extends InputStream {
    private volatile BlockingQueue<String> lines = new LinkedBlockingQueue<String>();
    ...
    private InputStream nextLine() throws IOException {
        try {
            ...
            while (lines != null && line == null) {
                line = lines.poll(1L, TimeUnit.SECONDS);
            }
            if (line != null) {
